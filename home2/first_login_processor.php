...
$stm = "UPDATE Clients SET Name='$name', Phone='$phone', Email='$email', Address='$address', referral='$reference', Profile_Completed='1', do_reset='', email_pref='$email_pref' WHERE client_id=$_SESSION[id]";
