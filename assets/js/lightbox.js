// Lightbox hash tag linking support modifications provided by Rüdiger Kaatz.
// -----------------------------------------------------------------------------------
//
//	Lightbox v2.04
...
Lightbox.prototype = {
    ...
    start: function(imageLink) {    
    	// the hash gets set to the original value after lightbox closes
    ...
    changeImage: function(imageNum) {   
        ...
        imgPreloader.onload = (function(){
            ...
            var hash=escape(this.imageArray[this.activeImage][0]);
