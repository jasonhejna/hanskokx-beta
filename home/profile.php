...
<div style="display:block; float: left; width: 100%;">
	<div id="container" style="min-height: 0px; margin-top: 10px;">
		...
		<div id="profile_content" style="height: 0px; overflow: hidden;"><? include('update.php'); ?></div>
	</div>
</div>
...
<div style="display:block; float: left; width: 100%;">
        <div id="container" style="min-height: 0px; margin-top: 10px;">
                ...
                <div id="password_form_content" style="height: 0px; overflow: hidden;"><? include('password_form.php'); ?></div>
        </div>
</div>
...
<div style="display:block; float: left; width: 100%;">
        <div id="container" style="min-height: 0px; margin-top: 10px;">
                ...
                <div id="email_prefs_content" style="height: 0px; overflow: hidden;"><? include('email_prefs.php'); ?></div>
        </div>
</div>
